...
export default function EventsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B0F19] text-slate-900 dark:text-slate-100 font-sans selection:bg-pink-500 selection:text-white transition-colors duration-300">
      ...
      {/* Event Registration Modal with Pass Generator */}
      {registerModalOpen && selectedEventForReg && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-fadeIn">
          <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl p-6 sm:p-8 overflow-hidden max-h-[90vh] overflow-y-auto">
            <button
            ...
            {registrationPass ? (
              ...
              <div className="text-center space-y-6 py-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                    Your digital event pass is generated below. We sent confirmation to your email.
                  </p>
                </div>

                {/* Digital Ticket Card */}
                <div className="bg-gradient-to-br from-blue-900 to-purple-900 text-white rounded-2xl p-6 shadow-2xl relative overflow-hidden border border-blue-400/30 text-left space-y-4">
                  ...
                  <div>
                    <span className="text-[10px] text-blue-200 uppercase font-semibold block">ATTENDEE</span>
                    <h4 className="text-lg font-bold">{registrationPass.name}</h4>
                  </div>

                  <div>
                    <span className="text-[10px] text-blue-200 uppercase font-semibold block">EVENT</span>
                    <h5 className="text-sm font-semibold leading-tight text-blue-100">{registrationPass.eventTitle}</h5>
                  </div>

                  <div className="flex justify-between items-center text-xs text-blue-200 pt-2 border-t border-white/20">
                    <div>
                      <span className="block text-[10px] text-blue-300 font-semibold">DATE</span>
                      {registrationPass.date}
                    </div>
                    <div>
                      <span className="block text-[10px] text-blue-300 font-semibold">TIME</span>
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl font-bold text-sm text-white jvm-gradient-bg shadow-lg hover:opacity-95"
                >
                  Done & Save Pass
                </button>
              </div>
              ...
              <div className="space-y-5">
                <div>
                  <span className="px-3 py-1 rounded-full text-[11px] font-bold uppercase bg-blue-100 dark:bg-blue-950/80 text-blue-600 dark:text-blue-400">
                    Free Registration
                  </span>
                ...
                <form onSubmit={handleSubmitRegistration} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-900 dark:text-white"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-3.5 px-6 rounded-xl font-bold text-white jvm-gradient-bg hover:opacity-95 shadow-lg transition-all flex items-center justify-center gap-2 text-sm"
                  >
                    {isSubmitting ? (
                      <span>Generating Pass...</span>
                    ) : (
                      <>
                        <Ticket className="w-4 h-4" /> Confirm Free Registration
                      </>
                    )}
                  </button>
                </form>
