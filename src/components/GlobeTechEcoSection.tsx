    ...
    <section className="py-12 sm:py-20 md:py-24 bg-gradient-to-b from-white via-slate-50 to-white dark:from-[#0B0F19] dark:via-[#0F172A] dark:to-[#0B0F19] relative overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="lg:col-span-6 relative flex items-center justify-center min-h-[340px] sm:min-h-[520px] lg:min-h-full py-4 sm:py-6 overflow-hidden">
            ...
            <div className="relative w-[280px] h-[280px] sm:w-[480px] sm:h-[480px] flex items-center justify-center">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="animate-[spin_22s_linear_infinite_reverse]">
                        <div className="w-12 h-12 sm:w-20 sm:h-20 flex items-center justify-center filter drop-shadow-xl hover:scale-125 transition-transform cursor-pointer">
                          <Image 
                            src={node.logoImg}
                            alt={node.name}
                            width={50}
