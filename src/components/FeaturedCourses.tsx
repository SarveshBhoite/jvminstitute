...
const CloudAIIcon = (props: { className?: string }) => (
  <div className="relative flex items-center justify-center">
    <Cloud className={props.className} />
    <span className="absolute -bottom-1 -right-1 text-[8px] sm:text-[9px] font-black bg-gradient-to-r from-[#1E2B88] to-[#7C248C] dark:from-purple-500 dark:to-pink-500 text-white px-1 py-0.5 rounded leading-none shadow-xs tracking-wider">
      AI
    </span>
  </div>
);
...
const coursesData = [
  ...
  {
    id: "basic-ai-ml",
    slug: "basic-ai-machine-learning-course-in-pune",
    title: "Basic AI & ML",
  ...
  {
    id: "advanced-ai-ml",
    slug: "advanced-ai-machine-learning-course-in-pune",
